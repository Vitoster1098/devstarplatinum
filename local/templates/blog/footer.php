...
<div class="sidebar">
    ...
    <div class="popular-post">
        <h3>popular-posts</h3>
        <div class="post-grid">
            <img src="<? echo DEFAULT_TEMPLATE_PATH?>/images/latest-post-img1.jpg" title="post1" alt=""/>
            <p>Lorem ipsum dolor sit amet consectetur dolor more normal of letters,<a href="#">[...]</a></p>
            <div class="clear"> </div>
        </div>
        <div class="post-grid">
            <img src="<? echo DEFAULT_TEMPLATE_PATH?>/images/latest-post-img2.jpg" title="post1" alt=""/>
            <p>Lorem ipsum dolor sit dolor more normal consectetur of letters,<a href="#">[...]</a></p>
            <div class="clear"> </div>
        </div>
        <div class="post-grid">
            <img src="<? echo DEFAULT_TEMPLATE_PATH?>/images/latest-post-img3.jpg" title="post1" alt=""/>
    ...
    <div class="latest_photos">
        <h3>Latest Photos</h3>
        <link rel="stylesheet" href="<? echo DEFAULT_TEMPLATE_PATH?>/css/swipebox.css">
        <script src="<? echo DEFAULT_TEMPLATE_PATH?>/js/jquery.swipebox.min.js"></script>
            ...
            <div class="section group">
                <div class="grid_1_of_4 images_1_of_4">
                    <a href="images/latest-post-img1.jpg" class="b-link-stripe b-animate-go  swipebox"  title="Image Title">
                        <img src="<? echo DEFAULT_TEMPLATE_PATH?>/images/latest-post-img1.jpg" alt="" class="img-responsive">
                    </a>
                </div>
                <div class="grid_1_of_4 images_1_of_4">
                    <a href="images/latest-post-img2.jpg" class="b-link-stripe b-animate-go  swipebox"  title="Image Title">
                        <img src="<? echo DEFAULT_TEMPLATE_PATH?>/images/latest-post-img2.jpg" alt="" class="img-responsive">
                    </a>
                </div>
                <div class="grid_1_of_4 images_1_of_4">
                    <a href="images/latest-post-img3.jpg" class="b-link-stripe b-animate-go  swipebox"  title="Image Title">
                        <img src="<? echo DEFAULT_TEMPLATE_PATH?>/images/latest-post-img3.jpg" alt="" class="img-responsive">
                    </a>
                </div>
                <div class="grid_1_of_4 images_1_of_4">
                    <a href="images/latest-post-img1.jpg" class="b-link-stripe b-animate-go  swipebox"  title="Image Title">
        ...
        <div class="wrap">
            <div class="footer_grid1">
                ...
                <div class="tweet_data">
                    <div class="tweet_img">
                        <img src="<? echo DEFAULT_TEMPLATE_PATH?>/images/tweet-img1.jpg" alt=""/>
                    </div>
                ...
                <div class="tweet_data">
                    <div class="tweet_img">
                        <img src="<? echo DEFAULT_TEMPLATE_PATH?>/images/tweet-img2.jpg" alt=""/>
                    </div>
                    <div class="tweet_desc">
                ...
                <div class="tweet_data">
                    <div class="tweet_img">
                        <img src="<? echo DEFAULT_TEMPLATE_PATH?>/images/tweet-img3.jpg" alt=""/>
                    </div>
                    <div class="tweet_desc">
                        <h4>May 4th, 2013</h4>
                        <p>Integer eget tortor et elit venenatis auctor morbi turpis nulla</p>
            ...
            <div class="footer_grid3">
                ...
                <div class="social_icons">
                    <div class="img_list">
                        <ul>
                            <li><img src="<? echo DEFAULT_TEMPLATE_PATH?>/images/facebook.png" alt="" /><a href="#">Facebook</a></li>
                            <li><img src="<? echo DEFAULT_TEMPLATE_PATH?>/images/google+.png" alt="" /><a href="#">Google Plus</a></li>
                            <li><img src="<? echo DEFAULT_TEMPLATE_PATH?>/images/twitter.png" alt="" /><a href="#">Twitter</a></li>
                            <li><img src="<? echo DEFAULT_TEMPLATE_PATH?>/images/linkedin.png" alt="" /><a href="#">Likedin</a></li>
                        </ul>
                    </div>
                </div>
            </div>
